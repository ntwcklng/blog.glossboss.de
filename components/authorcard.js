...
export default function AuthorCard({ author }) {
  return (
    <div className="px-8 py-8 mt-3 text-gray-500 rounded-2xl bg-gray-50 dark:bg-gray-800 dark:text-gray-400">
      <div className="flex flex-wrap items-start sm:space-x-6 sm:flex-nowrap">
        ...
        <div>
          ...
          <div className="mt-3 text-sm text-blue-600 rounded-full dark:text-blue-500 hover:translate-x-1 transition-all">
