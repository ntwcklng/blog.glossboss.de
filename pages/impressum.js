    ...
    <Layout
      ...
      <Container>
        <div className="mx-auto my-3 prose-base dark:prose-invert prose-a:text-blue-500">
          ...
          <p>Vertreten durch: Marvin Mieth</p>
          <p>
            Kontakt: Telefon: Fragen zum Thema Autopflege nur per
            eMail! 01703262412
          </p>
          <p>
            E-Mail:{" "}
          ...
          <p>46282 Dorsten</p>
          <p>
            Für Artikel und Beiträge die nicht vom Website-Betreiber
            stammen ist der jeweiliger Author verantwortlich
          </p>
          <p>
            <strong>Werbung:</strong>
            Die mit <i>Werbung</i> gekennzeichneten Links sind
            sogenannte Affiliate-Links, die mit dem Partnerprogramm
            von Amazon verknüpft sind. Kommt über einen solchen Link
            ein Einkauf zustande, werde ich mit einer Provision
            beteiligt. Für Dich entstehen dabei keine Mehrkosten. Wo,
            wann und wie Du ein Produkt kaufst, bleibt natürlich Dir
            überlassen.
          </p>
          ...
          <p>
            ...
            ist nicht möglich. Der Nutzung von im Rahmen der
